...
import de.maibornwolff.ste.testVille.managementTools.hpALM.exportProcess.ExportHandler;
import de.maibornwolff.ste.testVille.managementTools.jiraXRAY.helpers.TranslationMapBuilder;
import de.maibornwolff.ste.testVille.optionSwitchAndHandle.AnalysisRunSetting;
import de.maibornwolff.ste.testVille.optionSwitchAndHandle.OptionHandler;
import java.io.File;
...
public class VisualizationFileGenerator {
    ...
    private void generateVisualizationFileXray() throws Exception {
        de.maibornwolff.ste.testVille.managementTools.jiraXRAY.collectItems.ExportHandler eh;
        eh = new de.maibornwolff.ste.testVille.managementTools.jiraXRAY.collectItems.ExportHandler(this.runSetting.getExportFilePath());
