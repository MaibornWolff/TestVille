 ...
 * @test {TooltipService}
 */
describe("app.testVille.core.tooltip.tooltipService", function() {

    var tooltipService;

    beforeEach(angular.mock.module("app.testVille.core.tooltip"));
    ...
    describe("Service.getTooltipTextByKey.test", ()=>{
