...
describe("app.testVille.ui.legendPanel.legendPanelController", function() {

    var legendPanelController, dataService, scope, codeMapMaterialFactory, timeout, settingsService;

    beforeEach(angular.mock.module("app.testVille.ui.legendPanel"));
    ...
    describe("generatePixel tests", function() {
    ...
    describe("getImageDataUri tests", function() {
    ...
    describe("encodeHex tests", function() {
    ...
    describe("encodeRGB tests", function() {
    ...
    describe("encodeTriplet tests", function() {
